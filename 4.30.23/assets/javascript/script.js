    ...
    try {
        ...
        .then(function(data){
            ...
            // consuming api
                ...
                const nutritionalValue = { Name: foodName, Potasium: Potasium, Calcium: Calcium , Proteins: Proteins , cabs: cabs , cholestral: cholestral , fats: fats , calories: calories };

                saveToLocalStorage(foodName, nutritionalValue);

            }else{
                alert("Include weight of food in pounds")
            }
        })
...
function getToRecipe(){
    window.open("https://developer.edamam.com/recipe-demo")
}